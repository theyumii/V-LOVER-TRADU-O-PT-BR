V-Lover PT-BR — BepInEx runtime plugin

Instalação

Certifique-se de que o BepInEx 6 IL2CPP está instalado na pasta do jogo.
...
Se o jogo não iniciar, remova essa pasta e consulte o arquivo BepInEx\LogOutput.log.




Tradução feita por: Yumi (thistastesyumi)
